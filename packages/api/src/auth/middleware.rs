use axum::{response::IntoResponse, middleware::Next, http::Request, extract::{FromRequest, RequestParts}};
use super::Claims;

pub async fn auth_bearer_middleware<B: std::marker::Send>(req: Request<B>, next: Next<B>) -> impl IntoResponse {
